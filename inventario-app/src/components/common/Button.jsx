export default function Button({
  ...
  const variants = {
    ...
    success: 'bg-gradient-success text-slate-800 hover:shadow-card-hover focus:ring-success-500 shadow-soft',
    danger: 'bg-gradient-danger text-white hover:shadow-card-hover focus:ring-danger-500 shadow-soft',
    warning: 'bg-gradient-warning text-slate-800 hover:shadow-card-hover focus:ring-warning-500 shadow-soft',
